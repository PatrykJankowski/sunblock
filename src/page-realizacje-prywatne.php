<?php /* Template Name: Realizacje prywatne */ ?>
    ...
    <section class="realizacje">
        <div class="container">
            ...
            <div class="row realizacje__menu-wrapper">
                <div class="col-md-6"><a href="/realziacje/prywatne" class="realizacje__menu realizacje__menu--active">Pomieszczenia prywatne</a></div>
